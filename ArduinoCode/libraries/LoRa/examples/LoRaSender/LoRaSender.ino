...
static const u4_t DEVADDR = 0x01f1c999;
...
// Hàm bật module LoRa
void turnOnLoRa() {
  // digitalWrite(8, HIGH);  // Bật nguồn cấp của module LoRa
  LoRa.begin(915E6);  // Khởi động module LoRa với tần số 915MHz (hoặc tần số tương ứng)
}

// Hàm tắt module LoRa
void turnOffLoRa() {
  LoRa.end();  // Dừng module LoRa
  // digitalWrite(8, LOW);  // Tắt nguồn cấp của module LoRa
}