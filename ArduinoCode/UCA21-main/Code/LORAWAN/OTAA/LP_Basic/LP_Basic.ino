...
// This should also be in little endian format, see above. 53a0bcffee07340a
static const u1_t PROGMEM DEVEUI[8] = { 0x53, 0xa0, 0xbc, 0xff, 0xee, 0x07, 0x34, 0x0a };
...
static const u1_t PROGMEM APPKEY[16] = { 0xA1, 0x84, 0xB7, 0x75, 0xCC, 0x17, 0xCB, 0x6F, 0x5E, 0x30, 0xD6, 0xCC, 0x31, 0xCC, 0x2E, 0x75 };
